...
//    cout << "ESP Console Example, Version: " CONFIG_APP_PROJECT_VER "-" CONFIG_APP_PROJECT_FLAVOUR " of " CONFIG_APP_PROJECT_DATE << endl;
     ...
     cout << "=== aso::format test call ======================================================" << endl;
     cout << "Summa of the 2 & 3" << aso::sum2(2, 3) << endl;
//     cout << "Summa of the 3 & 7 with carring curried_sum2(3)(7): " << aso::curried_sum2(3)(7) /*<< endl*/;
     auto aa = std::bind(aso::sum2, 3, std::placeholders::_1);
     cout << "Summa of the 3 & 7 with carring curried_sum2(3)(7): " << aa(7) /*<< endl*/;
     //aa(3);
