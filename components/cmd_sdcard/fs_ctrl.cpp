...
#define CMD_NM "ls"
	...
	if (!artificial_cwd.valid(pattern.c_str()))
	{
	    ...
	    return ESP_ERR_NOT_FOUND;
    	    ...
    	    std::string in_pattern = artificial_cwd.compose(pattern/*.c_str()*/);
